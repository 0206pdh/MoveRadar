...
| SEOUL_DISTRICTLEVEL_DATA_FLOATING_POPULATION_CONSUMPTION_AND_ASSETS | GRANDATA | CARD_SALES_INFO | 카드소비 이사지표 (4번째 신호) |
...
| KOREA_TRAFFIC_SPEED__VOLUME_DATA__TMAP_NATIONWIDE_COVERAGE | TRAFFIC | TMAP_TRAFFIC_VOLUME | 교통 속도 컨텍스트 (LLM 프롬프트 보조) |
